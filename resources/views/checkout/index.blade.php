...
<div class="max-w-2xl mx-auto mt-6 bg-white p-6 rounded shadow">
    ...
    <form method="POST" action="{{ route('checkout.processar') }}" class="space-y-4">
        ...
        <div>
            ...
            <input type="text" name="nome" required class="mt-1 block w-full border px-3 py-2 rounded-md shadow-sm" />
        </div>

        <div>
            <label class="block font-medium text-sm text-gray-700">Idade</label>
            <input type="number" name="idade" min="0" required class="mt-1 block w-full border px-3 py-2 rounded-md" />
        </div>

        <div>
            <label class="block font-medium text-sm text-gray-700">Estado Civil</label>
            <select name="estado_civil" required class="mt-1 block w-full border px-3 py-2 rounded-md">
        ...
        <div>
            ...
            <input type="number" name="quantidade_filhos" min="0" class="mt-1 block w-full border px-3 py-2 rounded-md" />
        </div>

        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div>
                <label class="block font-medium text-sm text-gray-700">Dia do Mês</label>
                <input type="number" name="dia_mes" min="1" max="31" class="mt-1 block w-full border px-3 py-2 rounded-md" />
            </div>

            <div>
                <label class="block font-medium text-sm text-gray-700">Dia da Semana</label>
                <select name="dia_semana" class="mt-1 block w-full border px-3 py-2 rounded-md">
                    <option value="">Selecione</option>
        ...
        <div>
            ...
            <input type="time" name="horario" class="mt-1 block w-full border px-3 py-2 rounded-md" />
        </div>
        ...
        <section>
            ...
            <div>
                ...
                <select name="tipo_pagamento" class="mt-1 block w-full border px-3 py-2 rounded-md">
                    <option value="">Selecione</option>
